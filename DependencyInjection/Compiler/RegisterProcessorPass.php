 ...
 */
class RegisterProcessorPass implements CompilerPassInterface
{
     ...
     */
    public function __construct($registryServiceName = 'abc.scheduler.processor_registry', $tagName = 'abc.scheduler.processor')
    {
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds($this->tagName) as $id => $tags)
        {
            foreach ($tags as $tag)
            {
                ...
                $definition->addMethodCall('register',  array($tag['type'], new Reference($id)));
            }
        }
    }
}